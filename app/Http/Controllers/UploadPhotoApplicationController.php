...
class UploadPhotoApplicationController extends Controller
{
    /**
    ...
    {
        $photo = PhotoApplication::paginate(10);
        $titre = 'photo';
        return view('admin.applications.photo.liste',compact('photo','titre'));
    }
    ...
    {
        $element = PhotoApplication::findOrFail($id);
        $element->delete();
