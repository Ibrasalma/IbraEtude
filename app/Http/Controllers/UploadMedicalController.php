...
class UploadMedicalController extends Controller
{
    /**
    ...
    {
        $photo = Medical::paginate(10);
        $titre = 'medical';
        return view('admin.applications.medicals.liste',compact('photo','titre'));
    }
