...
class UploadBankStatementController extends Controller
{
    /**
    ...
    {
        $photo = BankStatement::paginate(10);
        $titre = 'banque';
        return view('admin.applications.bank.liste',compact('photo','titre'));
    }
    ...
    {
        $element = BankStatement::findOrFail($id);
        $element->delete();
