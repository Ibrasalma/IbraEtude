...
class UploadPlanEtudeController extends Controller
{
    /**
    ...
    {
        $photo = StudyPlan::paginate(10);
        $titre = 'plan etude';
        return view('admin.applications.study_plan.liste',compact('photo','titre'));
    }
    ...
    {
        $element = StudyPlan::findOrFail($id);
        $element->delete();
