...
class UploadLangueController extends Controller
{
    /**
    ...
    {
        $photo = Language::paginate(10);
        $titre = 'certificate langue';
        return view('admin.applications.langues.liste',compact('photo','titre'));
    }
    ...
    {
        $element = Language::findOrFail($id);
        $element->delete();
