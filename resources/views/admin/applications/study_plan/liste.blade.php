        ...
        <div class="panel-heading">
          <div class="row">
            <div class="col col-xs-6">
              <h3 class="panel-title">Il y'a {{ $photo->count() }}{{ Str::plural(' plan etude',$photo->count())}} documents soumis</h3>
            </div>
          </div>
        </div>
            ...
            <tbody>
              ...
              <tr>
                <td>
                  ...
                  <td>
                    <?php 
                      $image = App\Models\StudyPlan::where('id',$avatar->id)->first()->location;
