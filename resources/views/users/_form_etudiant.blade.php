<div class="step1">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <select name="nationality" id="nationality" class="form-control {{ $errors->has('nationality') ? 'is-invalid' : '' }}" style="height: 2.5em;">
                ...
                @foreach ($pays as $element)
                  ...
                  <option value="{{ $element }}" {{ ($element==$story->nationality) ? 'selected="selected"' : '' }}>{{ $element }}</option>
                @endforeach
            </select>
        </div>
        <div class="col-md-6 form-group">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="gender" id="gender" value="M" {{ ($story->gender=='M') ? 'checked="checked"' : '' }}>
                <label class="form-check-label" for="gender">M</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="gender" id="gender" value="F" {{ ($story->gender=='F') ? 'checked="checked"' : '' }}>
    ...
    <div class="row">
        <div class="col-md-6 ">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="marital_status" id="status" value="marriee" {{ ($story->marital_status=='marriee') ? 'checked="checked"' : '' }}>
                <label class="form-check-label" for="status">Marié(e)</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="marital_status" id="status" value="celibataire" {{ ($story->marital_status=='celibataire') ? 'checked="checked"' : '' }}>
                <label class="form-check-label" for="status">Célibataire</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="marital_status" id="status" value="divorce" {{ ($story->marital_status=='divorce') ? 'checked="checked"' : '' }}>
                <label class="form-check-label" for="status">Divorcé(e)</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="marital_status" id="status" value="veuf" {{ ($story->marital_status=='veuf') ? 'checked="checked"' : '' }}>
    ...
    <div class="row">
        <div class="col-md-6 form-group">
            ...
            <select name="highest_degree" id="diplome" class="form-control {{ $errors->has('highest_degree') ? 'is-invalid' : '' }}" style="height: 2.5em;">
                ...
                <?php $element = substr($element,1,-1) ?>
                <option value="{{ $element }}" {{ ($element==$story->highest_degree) ? 'selected="selected"' : '' }}>{{ $element }}</option>
                @endforeach
            </select>
        </div>
        <div class="col-md-6 form-group">
        ...
        <div class="col-md-6">
            <div class="row">
                <div class="col-md-4 col-xs-4 form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="is_in_china" id="isChina" value="1" {{ ($story->is_in_china==1) ? 'checked="checked"' : '' }}>
                        <label class="form-check-label" for="isChina">Oui</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="is_in_china" id="isChina" value="0" {{ ($story->is_in_china==0) ? 'checked="checked"' : '' }}>
                ...
                <div class="col-md-8 col-xs-8 form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="studied_china" id="studyChina" value="1" {{ ($story->studied_china==1) ? 'checked="checked"' : '' }}>
                        <label class="form-check-label" for="studyChina">Oui</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="studied_china" id="studyChina" value="0" {{ ($story->studied_china==0) ? 'checked="checked"' : '' }}>
